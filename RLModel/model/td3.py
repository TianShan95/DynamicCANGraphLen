...
class TD3:
    ...
    def save(self):
        torch.save(self.actor.state_dict(), args_RL.model_store_dir+'actor.pth')
        torch.save(self.actor_target.state_dict(), args_RL.model_store_dir+'actor_target.pth')
        torch.save(self.critic_1.state_dict(), args_RL.model_store_dir+'critic_1.pth')
        torch.save(self.critic_1_target.state_dict(), args_RL.model_store_dir+'critic_1_target.pth')
        torch.save(self.critic_2.state_dict(), args_RL.model_store_dir+'critic_2.pth')
        torch.save(self.critic_2_target.state_dict(), args_RL.model_store_dir+'critic_2_target.pth')
        print("====================================")
        print("Model has been saved...")
        print("====================================")

    def load(self):
        self.actor.load_state_dict(torch.load(args_RL.model_load_dir + 'actor.pth'))
        self.actor_target.load_state_dict(torch.load(args_RL.model_load_dir + 'actor_target.pth'))
        self.critic_1.load_state_dict(torch.load(args_RL.model_load_dir + 'critic_1.pth'))
        self.critic_1_target.load_state_dict(torch.load(args_RL.model_load_dir + 'critic_1_target.pth'))
        self.critic_2.load_state_dict(torch.load(args_RL.model_load_dir + 'critic_2.pth'))
        self.critic_2_target.load_state_dict(torch.load(args_RL.model_load_dir + 'critic_2_target.pth'))
        print("====================================")
