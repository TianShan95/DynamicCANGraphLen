...
class TD3:
    def __init__(self, state_dim, action_dim, max_action, args, log_out_dir):
        ...
        critic_graph = hl.build_graph(self.critic_1, (torch.zeros([1,  args.state_dim, 1]).to(device), torch.zeros([1, args.msg_biggest_num - args.msg_smallest_num + 1, 1]).to(device)))
